...
<div class="module-list-container">
    <%include file="review_management_index_strip.tpl"%>
...
<%javascript%>
    ...
    {
        "name": "r_review_type",
        "label": "<%$list_config['r_review_type']['label_lang']%>"
    },
    {
        "name": "r_status",
    ...
    js_col_model_json = [
    {
        ...
        "searchoptions": {
            "attr": {
                ...
                "aria-module-name": "review_management",
    ...
    
    {
        ...
        "labelClass": "header-align-left",
        "resizable": true,
        "width": "<%$list_config['r_review_type']['width']%>",
        "search": <%if $list_config['r_review_type']['search'] eq 'No' %>false<%else%>true<%/if%>,
        "export": <%if $list_config['r_review_type']['export'] eq 'No' %>false<%else%>true<%/if%>,
        "sortable": <%if $list_config['r_review_type']['sortable'] eq 'No' %>false<%else%>true<%/if%>,
        "hidden": <%if $list_config['r_review_type']['hidden'] eq 'Yes' %>true<%else%>false<%/if%>,
        "hideme": <%if $list_config['r_review_type']['hideme'] eq 'Yes' %>true<%else%>false<%/if%>,
        "addable": <%if $list_config['r_review_type']['addable'] eq 'Yes' %>true<%else%>false<%/if%>,
        "editable": <%if $list_config['r_review_type']['editable'] eq 'Yes' %>true<%else%>false<%/if%>,
        "align": "left",
        "edittype": "text",
        "editrules": {
            "infoArr": []
        ...
        "searchoptions": {
            "attr": {
                "aria-grid-id": el_tpl_settings.main_grid_id,
                "aria-module-name": "review_management",
                "aria-unique-name": "r_review_type",
                "autocomplete": "off"
            },
            "sopt": strSearchOpts,
            "searchhidden": <%if $list_config['r_star']['search'] eq 'Yes' %>true<%else%>false<%/if%>
        ...
        "ctrl_type": "textbox",
        "default_value": "<%$list_config['r_review_type']['default']%>",
        "filterSopt": "bw",
        "formatter": formatAdminModuleEditLink,
        "unformat": unformatAdminModuleEditLink
    },
