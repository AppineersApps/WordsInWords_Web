...
<%javascript%>
    ...
    {
        "name": "b_name",
        "label": "<%$list_config['b_name']['label_lang']%>"
    },
    {
        "name": "b_status",
        "label": "<%$list_config['b_status']['label_lang']%>"
    }
    ];
    ...
    js_col_model_json = [
    {
        ...
        "resizable": true,
        "width": "<%$list_config['b_name']['width']%>",
        "search": <%if $list_config['b_name']['search'] eq 'No' %>false<%else%>true<%/if%>,
        "export": <%if $list_config['b_name']['export'] eq 'No' %>false<%else%>true<%/if%>,
        "sortable": <%if $list_config['b_name']['sortable'] eq 'No' %>false<%else%>true<%/if%>,
        "hidden": <%if $list_config['b_name']['hidden'] eq 'Yes' %>true<%else%>false<%/if%>,
        "hideme": <%if $list_config['b_name']['hideme'] eq 'Yes' %>true<%else%>false<%/if%>,
        "addable": <%if $list_config['b_name']['addable'] eq 'Yes' %>true<%else%>false<%/if%>,
        "editable": <%if $list_config['b_name']['editable'] eq 'Yes' %>true<%else%>false<%/if%>,
        "align": "left",
        "edittype": "text",
        "editrules": {
            "infoArr": []
        ...
        "searchoptions": {
            "attr": {
                ...
                "aria-unique-name": "b_name",
                "autocomplete": "off"
            },
            "sopt": strSearchOpts,
            "searchhidden": <%if $list_config['b_name']['search'] eq 'Yes' %>true<%else%>false<%/if%>
        },
        "editoptions": {
            "aria-grid-id": el_tpl_settings.main_grid_id,
            "aria-module-name": "businesstype_management",
        ...
        "ctrl_type": "textbox",
        "default_value": "<%$list_config['b_name']['default']%>",
        "filterSopt": "bw",
    ...
    
    {
        ...
        "labelClass": "header-align-left",
        "resizable": true,
        "width": "<%$list_config['b_status']['width']%>",
        "search": <%if $list_config['b_status']['search'] eq 'No' %>false<%else%>true<%/if%>,
        "export": <%if $list_config['b_status']['export'] eq 'No' %>false<%else%>true<%/if%>,
        "sortable": <%if $list_config['b_status']['sortable'] eq 'No' %>false<%else%>true<%/if%>,
        "hidden": <%if $list_config['b_status']['hidden'] eq 'Yes' %>true<%else%>false<%/if%>,
        "hideme": <%if $list_config['b_status']['hideme'] eq 'Yes' %>true<%else%>false<%/if%>,
        "addable": <%if $list_config['b_status']['addable'] eq 'Yes' %>true<%else%>false<%/if%>,
        "editable": <%if $list_config['b_status']['editable'] eq 'Yes' %>true<%else%>false<%/if%>,
        "align": "left",
        "edittype": "text",
        "editrules": {
            "infoArr": []
        ...
        "searchoptions": {
            "attr": {
                "aria-grid-id": el_tpl_settings.main_grid_id,
                "aria-module-name": "businesstype_management",
                "aria-unique-name": "b_status",
                "autocomplete": "off"
            },
            "sopt": strSearchOpts,
            "searchhidden": <%if $list_config['b_status']['search'] eq 'Yes' %>true<%else%>false<%/if%>
        },
        "editoptions": {
            "aria-grid-id": el_tpl_settings.main_grid_id,
            "aria-module-name": "businesstype_management",
        ...
        "ctrl_type": "textbox",
        "default_value": "<%$list_config['b_status']['default']%>",
        "filterSopt": "bw",
        "formatter": formatAdminModuleEditLink,
        "unformat": unformatAdminModuleEditLink
    }
