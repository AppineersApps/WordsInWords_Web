...
/**
 * Description of Game Level Model
 *
 * @category admin
 *
 * @package tools
 ...
 * @module Game Level
 *
 * @class Game_level_model.php
 *
 * @path application\admin\tools\models\Game_level_model.php
 *
 * @version 4.4
 *
 * @author CIT Dev Team
...
class Game_level_model extends CI_Model
{
    public $table_name;
    public $table_alias;
    public $primary_key;
    ...
    public function __construct()
    {
        ...
        $this->table_name = "game_level_master";
        $this->table_alias = "glm";
        $this->primary_key = "iGameLevelId";
        $this->primary_alias = "glm_game_level_id";
    ...
    {
        $list_config = array(
            "glm_level_name" => array(
                "name" => "glm_level_name",
                "table_name" => "game_level_master",
                "table_alias" => "glm",
                "field_name" => "vLevelName",
                "source_field" => "glm_level_name",
                "display_query" => "glm.vLevelName",
                "entry_type" => "Table",
                "data_type" => "varchar",
                "show_in" => "Both",
                "type" => "textbox",
                "align" => "left",
                "label" => "Level Name",
                "lang_code" => "GAME_LEVEL_LEVEL_NAME",
                "label_lang" => $this->lang->line('GAME_LEVEL_LEVEL_NAME'),
                "width" => 50,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
            ...
            "glm_description" => array(
                ...
                "source_field" => "glm_description",
                "display_query" => "glm.tDescription",
                "entry_type" => "Table",
                "data_type" => "enum",
                "show_in" => "Both",
                "type" => "dropdown",
            ...
            "glm_max_word_length" => array(
                ...
                "table_alias" => "glm",
                "field_name" => "iMaxWordLength",
                "source_field" => "glm_max_word_length",
                "display_query" => "glm.iMaxWordLength",
                "entry_type" => "Table",
                "data_type" => "enum",
                "show_in" => "Both",
                "type" => "dropdown",
            ...
            "glm_max_round" => array(
                ...
                "source_field" => "glm_max_round",
                "display_query" => "glm.iMaxRound",
                "entry_type" => "Table",
                "data_type" => "enum",
                "show_in" => "Both",
                "type" => "dropdown",
            ...
            "glm_round_to_unlock" => array(
                ...
                "source_field" => "glm_round_to_unlock",
                "display_query" => "glm.iRoundToUnlock",
                "entry_type" => "Table",
                "data_type" => "enum",
                "show_in" => "Both",
                "type" => "dropdown",
