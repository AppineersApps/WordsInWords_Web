...
/**
 * Description of Word Coin Model
 *
 * @category admin
 *
 * @package tools
 ...
 * @module Word Coin
 *
 * @class Word_coin_model.php
 *
 * @path application\admin\tools\models\Word_coin_model.php
 *
 * @version 4.4
 *
 * @author CIT Dev Team
...
class Word_coin_model extends CI_Model
{
    public $table_name;
    public $table_alias;
    public $primary_key;
    ...
    public function __construct()
    {
        ...
        $this->table_name = "word_coin_master";
        $this->table_alias = "wcm";
        $this->primary_key = "iWordCoinId";
        $this->primary_alias = "wcm_word_coin_id";
    ...
    {
        $list_config = array(
            "wcm_word_length" => array(
                "name" => "wcm_word_length",
                "table_name" => "word_coin_master",
                "table_alias" => "wcm",
                "field_name" => "iWordLength",
                "source_field" => "wcm_word_length",
                "display_query" => "wcm.iWordLength",
                "entry_type" => "Table",
                "data_type" => "enum",
                "show_in" => "Both",
                "type" => "dropdown",
                "align" => "center",
                "label" => "Word Length",
                "lang_code" => "WORD_COIN_WORD_LENGTH",
                "label_lang" => $this->lang->line('WORD_COIN_WORD_LENGTH'),
                "width" => 50,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
            ...
            "wcm_word_coin" => array(
                ...
                "source_field" => "wcm_word_coin",
                "display_query" => "wcm.iWordCoin",
                "entry_type" => "Table",
                "data_type" => "enum",
                "show_in" => "Both",
                "type" => "dropdown",
            ...
            "wcm_hint_coin" => array(
                ...
                "table_name" => "word_coin_master",
                "table_alias" => "wcm",
                "field_name" => "iHintCoin",
                "source_field" => "wcm_hint_coin",
                "display_query" => "wcm.iHintCoin",
                "entry_type" => "Table",
                "data_type" => "enum",
                "show_in" => "Both",
                "type" => "dropdown",
