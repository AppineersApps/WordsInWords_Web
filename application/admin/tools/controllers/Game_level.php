...
/**
 * Description of Game Level Controller
 *
 * @category admin
 *
 * @package tools
 ...
 * @module Game Level
 *
 * @class Game_level.php
 *
 * @path application\admin\tools\controllers\Game_level.php
 *
 * @version 4.4
 *
 * @author CIT Dev Team
...
class Game_level extends Cit_Controller
{
    /**
    ...
    public function __construct()
    {
        ...
        $this->load->model('game_level_model');
    ...
    public function listing()
    {
        ...
        $data_recs = $this->game_level_model->getListingData($data_config);
        $data_recs['no_records_msg'] = $this->general->processMessageLabel('ACTION_NO_GAME_LEVEL_DATA_FOUND_C46_C46_C33');
    ...
    public function export()
    {
        ...
        $table_alias = $this->game_level_modeltable_alias;
        $primary_key = $this->game_level_model->primary_key;
        $extra_cond = $this->game_level_model->extra_cond;
        $groupby_cond = $this->game_level_model->groupby_cond;
        $having_cond = $this->game_level_model->having_cond;
        $orderby_cond = $this->game_level_model->orderby_cond;
        ...
        $misc_info['heading'] = $this->lang->line('GAME_LEVEL_GAME_LEVEL');
        $misc_info['filename'] = "game_level_records_".count($db_recs);
    ...
    public function addAction()
    {
        ...
        try
        {
            ...
            elseif ($mode == 'Update')
            {
                ...
                $switch_combo = $this->game_level_model->getSwitchTo($track_cond);
                $recName = $switch_combo[0]["val"];
                $this->general->trackModuleNavigation("Module", "Form", "Modified", $this->mod_enc_url["add"], "game_level", $recName, "mode|".$this->general->getAdminEncodeURL("Update")."|id|".$this->general->getAdminEncodeURL($id));
            }
            $ret_arr['id'] = $id;
            $ret_arr['mode'] = $mode;
            $ret_arr['message'] = $msg;
    ...
    public function inlineEditAction()
    {
        ...
        if ($all_row_selected == "true" && in_array($operartor, array("del", "status")))
        {
            ...
            $config_arr['list_config'] = $this->game_level_model->getListConfiguration();
            $config_arr['form_config'] = $this->game_level_model->getFormConfiguration();
            $config_arr['table_name'] = $this->game_level_model->table_name;
            $config_arr['table_alias'] = $this->game_level_model->table_alias;
    ...
    public function getSelfSwitchTo()
    {
        ...
        $switchto_fields = $this->game_level_model->switchto_fields;
        $extra_cond = $this->game_level_model->extra_cond;
    ...
    public function getListOptions()
    {
        ...
        $config_arr = $this->game_level_model->getListConfiguration($alias_name);
