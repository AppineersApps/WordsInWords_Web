...
class Player_activity_model extends CI_Model
{
    ...
    /**
    * insert_player_activity_data method is used to execute database queries for Contact Add API.
    * @created  | 28.01.2016
    * @modified ---
        ...
        try {
            ...
            if ($player_activity_data['success']) {
                ...
                if (isset($params_arr["credit_coin"])) {
                    $credit_coin = $params_arr["credit_coin"];
                }
                if (isset($params_arr["debit_coin"])) {
                    $debit_coin = $params_arr["debit_coin"];
                }
                $gain_coin = $credit_coin - $debit_coin;
