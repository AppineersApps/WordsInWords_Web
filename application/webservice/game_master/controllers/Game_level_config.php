 ...
 *
 * @module Game_level_config Add
 *
 * @class Game_level_config.php
 *
 * @path application\webservice\game_level_master\controllers\Game_level_config.php
 *
 * @version 4.4
 *
 * @author CIT Dev Team
 ...
 * @since 06.09.2019
 */
class Game_level_config extends Cit_Controller
{
     ...
     */
    public function start_game_level_config($request_arr = array(), $inner_api = false)
    {
    ...
    public function get_game_level_master($input_params = array())
    {
        ...
        try {
            ...
            //$this->block_result = $this->game_level_master_model->get_word_coin_master($input_params);
            ...
            foreach ($this->block_result['data'] as $configKey => $configValue) {
                $gameLevelInfo[$newKey]['game_level_id'] = $configValue["iGameLevelId"];
                $gameLevelInfo[$newKey]['level_name'] = $configValue["vLevelName"];
                $gameLevelInfo[$newKey]['description'] = $configValue["tDescription"];
                $gameLevelInfo[$newKey]['min_word_length'] = $configValue["iMinWordLength"];
                $gameLevelInfo[$newKey]['max_word_length'] = $configValue["iMaxWordLength"];
                $gameLevelInfo[$newKey]['max_round'] = $configValue["iMaxRound"];
                $gameLevelInfo[$newKey]['round_to_unlock'] = $configValue["iRoundToUnlock"];
                ++$newKey;
            }
            ...
            foreach ($this->block_result['data'] as $configKey => $configValue) {
                $wordCoinInfo[$newUpKey]['word_coin_id'] = $configValue["iWordCoinId"];
            ...
            $this->block_result['data'][0]['game_levels'] = $gameLevelInfo;
            $this->block_result['data'][0]['word_coins'] = $wordCoinInfo;
        } catch (Exception $e) {
            $success = 0;
    ...
    public function get_game_level_master_list_finish_success($input_params = array())
    {
        ...
        $ouput_aliases = array(
            ...
            // "iMinWordLength" => "min_word_length",
