...
class Cit_Get_config_paramaters extends Get_config_paramaters
{
    ...
    public function returnConfigParams(&$input_params=array())
    {
        ...
        $return_arr['is_subscribed']='';
        $return_arr['expiry_date']='';
        ...
        if (!empty($userid)) {
            ...
            $this->db->select('vTermsConditionsVersion,vPrivacyPolicyVersion,eLogStatus,eIsSubscribed,dtExpiryDate');
            $this->db->from('users');
            ...
            $return_arr['expiry_date']=$version_data['dtExpiryDate'];
        }
