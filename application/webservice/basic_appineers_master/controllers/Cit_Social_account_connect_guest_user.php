 ...
 * 
 * @class Cit_Social_account_connect_guest_user.php
 * 
 * @path application\webservice\basic_appineers_master\controllers\Cit_Social_account_connect_guest_user.php
 * 
 * @author CIT Dev Team
 * 
 * @date 10.02.2020
...
Class Cit_Social_account_connect_guest_user extends Social_account_connect_guest_user {
