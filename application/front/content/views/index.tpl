                            ...
                            <div class="main-menu f-right d-none d-lg-block">
                                <nav>
                                    <ul id="navigation">    
                                       ...
                                       <li><a href="mailto:wordsinwordsmobileapp@gmail.com">Contact </a></li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
                        ...
                        <div class="row d-flex align-items-center">
                            <div class="col-lg-6 col-md-9 ">
                                <div class="hero__caption">
                                    <h1 data-animation="fadeInUp" data-delay=".6s">Get things done<br>with Words In Words</h1>
                                    <p data-animation="fadeInUp" data-delay=".8s">Find all the words in the word before time expires!</p>
                                    <!-- Slider btn -->
                        ...
                        <div class="row d-flex align-items-center">
                            ...
                            <div class="col-lg-6 col-md-9 ">
                                <div class="hero__caption">
                                    ...
                                    <p data-animation="fadeInUp" data-delay=".8s">Words in words is a gaming app where players find words that are in other words before time runs out.  Challenge the clock or a friend and see who can get the most words or all the words before time expires. </p>
                                    <!-- Slider btn -->
                                   <div class="slider-btns">
                                        <!-- Hero-btn -->
                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-6 col-md-6">
                                <div class="single-features mb-70">
                                    ...
                                    <div class="features-caption">
                                        <h3>Identify words in word</h3>
                                        <p>Identify words in particular word and earn coins.</p>
                                    </div>
                                </div>
                            </div>
                             <div class="col-xl-6 col-lg-6 col-md-6">
                                <div class="single-features mb-70">
                                    ...
                                    <div class="features-caption">
                                    	 <h3>Get hints</h3>
                                        <p>Spend coin and get hints to identify the word.</p>
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6">
                                <div class="single-features mb-70">
                                    ...
                                    <div class="features-caption">
                                       <h3>Earn coins</h3>
                                        <p>You can earn coins by identifying all words.
</p>
                                    </div>
                                </div>
                            </div>
                             <div class="col-xl-6 col-lg-6 col-md-6">
                                <div class="single-features mb-70">
                                    ...
                                    <div class="features-caption">
                                    	<h3>Buy coins</h3>
                                        <p>Buy a coins with lowest cost to earn more.</p>
               ...
               <div class="row d-flex justify-content-center">
                    <div class="col-lg-6">
                        <div class="section-tittle text-center">
                            <!-- <h2>How Can We HelpYour<br>with Words In Words!</h2> -->
                        </div>
                    </div>
                </div>
                <!-- Section caption -->
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="et_pb_text_6 text-center mb-30">
                            <div class="et_pb_text_inner"><h1 style="color:#000!important;font-size: 45px;font-weight: 600;border: unset;">How we can help you</h1>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-8">
                        <div class="single-cases-info mb-30">
                            <h3>Words In Words Apps<br> Screenshot</h3>
                            <p>Challenge the clock or your friends and find the words in the word!</p>
                        </div>
                    </div>
                    <!-- OwL -->
                    ...
                    <div class="col-xl-5 col-lg-6">
                        <div class="app-caption">
                            <div class="section-tittle section-tittle3">
                                ...
                                <p>Download Words In Words today!</p>
                                <div class="app-btn">
            ...
            <div class="container">
                <div class="row justify-content-between align-items-center">
                    ...
                    <div class="col-xl-2 col-lg-3">
                        <div class="say-btn">
                            <a href="mailto:wordsinwordsmobileapp@gmail.com" class="btn radius-btn">Contact Us</a>
                        </div>
                    </div>
                </div>
            </div>
