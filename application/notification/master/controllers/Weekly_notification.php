...
/**
 * Description of Weekly_notification Controller
 *
 ...
 *
 * @class Weekly_notification.php
 *
 * @path application\notifications\user\controllers\Weekly_notification.php
 *
 * @version 4.4
 *
 * @author CIT Dev Team
...
class Weekly_notification extends Cit_Controller
{
     ...
     */
    public function start_weekly_notification($request_arr = array())
    {
        try {
            ...
            $input_params = $this->getWeeklyEvent($input_params);
            if (false == empty($input_params['get_weekly_event'])) {
                $input_params = $this->prepare_reminder_notification($input_params);
                if (is_array($input_params['get_weekly_event']) && count($input_params['get_weekly_event']) > 0) {
                                $i = 0;
                                foreach ($input_params['get_weekly_event'] as $data_key2 => $row2) {
    ...
    public function post_notification($input_params = array())
    {
        ...
        try {
            ...
            $params_arr["_enotificationtype"] = "weekly";
    ...
    /**
     * getWeeklyEvent method is used to process query block.
     * @created Devangi Nirmal | 12.09.2019
     * @modified Devangi Nirmal | 12.09.2019
     * @param array $input_params input_params array to process loop flow.
     * @return array $input_params returns modfied input_params array.
     */
    public function getWeeklyEvent($input_params = array())
    {

        $this->block_result = array();
        try {
            $this->block_result = $this->notification_model->getWeeklyEvent();
        ...
        $input_params["get_weekly_event"] = $this->block_result["data"];
    ...
    public function finish_success($input_params = array())
    {
        ...
        $func_array["function"]["name"] = "get_weekly_event";
