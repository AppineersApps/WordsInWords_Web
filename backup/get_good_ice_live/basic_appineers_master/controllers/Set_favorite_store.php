...
class Set_favorite_store extends Cit_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('set_favorite_store_model');
    }
     ...
     */
    public function rules_set_favorite_store($request_arr = array())
    {
        $valid_arr = array(
     ...
     */
    public function start_set_favorite_store($request_arr = array(), $inner_api = FALSE)
    {
        try
        {
            $validation_res = $this->rules_set_favorite_store($request_arr);
            ...
            $condition_res = $this->get_favorite_store_details($input_params);
            if ($condition_res["success"])
            { 
                $input_params = $this->update_favorite_store($input_params);
                $condition_res = $this->is_posted($input_params);
                if ($condition_res["success"])
                {
                    $output_response = $this->set_favorite_store_finish_success($input_params);
                    return $output_response;

                }
                else
                {
                    $output_response = $this->set_favorite_store_finish_success_1($input_params);
                    return $output_response;
                }
            ...
            else
            {
               ...
               $input_params = $this->set_favorite_store($input_params);
                $condition_res = $this->is_posted($input_params);
                if ($condition_res["success"])
                {
                    $output_response = $this->set_favorite_store_finish_success($input_params);
     ...
     */
    public function update_favorite_store($input_params = array())
    {
        ...
        try
        {
            ...
            {
                $where_arr["store_id"] = $input_params["store_id"];
            }
            ...
            $this->block_result = $this->set_favorite_store_model->update_favorite_store($params_arr, $where_arr);
        }
        catch(Exception $e)
        {
            $success = 0;
     ...
     * @return array $input_params returns modfied input_params array.
     */
    public function get_favorite_store_details($input_params = array())
    {
        ...
        try
        {
            ...
            $this->block_result = $this->set_favorite_store_model->get_favorite_store_details($user_id,$store_id);
     ...
     * @return array $input_params returns modfied input_params array.
     */
    public function set_favorite_store($input_params = array())
    {
        $this->block_result = array();
        try
        {   
            ...
            $this->block_result = $this->set_favorite_store_model->set_favorite_store($params_arr);
        ...
        $input_params["set_favorite_store"] = $this->block_result["data"];
        $input_params = $this->wsresponse->assignSingleRecord($input_params, $this->block_result["data"]);
        return $input_params;
    }    
     ...
     */
    public function set_favorite_store_finish_success($input_params = array())
    {

        $setting_fields = array(
            "success" => "1",
            "message" => "set_favorite_store_finish_success",
        );
        $output_fields = array();
        $output_keys = array(
            'set_favorite_store',
        ...
        $func_array["function"]["name"] = "set_favorite_store";
     ...
     * @return array $responce_arr returns responce array of api.
     */
    public function set_favorite_store_finish_success_1($input_params = array())
    {

        $setting_fields = array(
            "success" => "0",
            "message" => "set_favorite_store_finish_success_1",
        );
        $output_fields = array();
