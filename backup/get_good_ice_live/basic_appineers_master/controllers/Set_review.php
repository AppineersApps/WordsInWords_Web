...
class Set_review extends Cit_Controller
{
     ...
     */
    public function rules_set_review($request_arr = array())
    {
        $valid_arr = array(
            "ice_type_id" => array(
                array(
     ...
     */
    public function start_set_review($request_arr = array(), $inner_api = FALSE)
    {
        try
        {
            $validation_res = $this->rules_set_review($request_arr);
