...
/**
 * Description of User Store Review Model
 *
 * @category admin
 *
 ...
 *
 * @class user_store_review_model.php
 *
 * @path application\admin\basic_appineers_master\models\user_store_review_model.php
 *
 * @version 4.4
 *
 * @author CIT Dev Team
...
class User_store_review_model extends CI_Model
{
    ...
    public function __construct()
    {
        ...
        $this->table_name = "user_store_review";
        $this->table_alias = "usr";
        $this->primary_key = "iUserReviewId";
        $this->primary_alias = "usr_user_review_id";
        ...
        $this->join_tables = array(
            array(
                ...
                "table_alias" => "u",
                "field_name" => "iUserId",
                "rel_table_name" => "user_store_review",
                "rel_table_alias" => "usr",
        ...
        $this->relation_modules = array(
            "user_review_images" => array(
                "module" => "user_review_images",
                "folder" => "basic_appineers_master",
                "rel_source" => "iUserReviewId",
                "rel_target" => "iUserReviewId",
                "extra_cond" => "",
                "popup" => "No",
            )
        );
    ...
    public function getData($extra_cond = "", $fields = "", $order_by = "", $group_by = "", $limit = "", $join = "No", $having_cond = '', $list = FALSE)
    {
        ...
        {
            $this->db->select("usr.iUserReviewId AS iUserReviewId");
            $this->db->select("usr.iUserReviewId AS usr_user_review_id");
            $this->db->select("usr.iUserId AS usr_user_id");
            $this->db->select("usr.tComment AS usr_comment");
            $this->db->select("usr.dtAddedAt AS usr_added_at");
            $this->db->select("usr.eStatus AS usr_status");
    ...
    public function getListConfiguration($name = "")
    {
        $list_config = array(
            "u_first_name" => array(
                ...
                "align" => "left",
                "label" => "Full Name",
                "lang_code" => "USER_STORE_REVIEW_FULL_NAME",
                "label_lang" => $this->lang->line('USER_STORE_REVIEW_FULL_NAME'),
                "width" => 50,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
            ...
            "usr_comment" => array(
                ...
                "table_alias" => "usr",
                "field_name" => "tComment",
                "source_field" => "usr_comment",
                "display_query" => "usr.tcomment",
                "entry_type" => "Table",
                "data_type" => "text",
                "show_in" => "Both",
                "type" => "textarea",
                "align" => "left",
                "label" => "comment",
                "lang_code" => "USER_STORE_REVIEW_COMMENT",
                "label_lang" => $this->lang->line('USER_STORE_REVIEW_COMMENT'),
                "width" => 50,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
            ...
            "usr_added_at" => array(
                ...
                "source_field" => "usr_added_at",
                "display_query" => "usr.dtAddedAt",
                "entry_type" => "Table",
                "data_type" => "datetime",
                "show_in" => "Both",
                "type" => "date",
                "align" => "left",
                "label" => "Reported On",
                "lang_code" => "USER_STORE_REVIEW_REPORTED_ON",
                "label_lang" => $this->lang->line('USER_STORE_REVIEW_REPORTED_ON'),
                "width" => 50,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
            ...
            "usr_status" => array(
                ...
                "table_alias" => "usr",
                "field_name" => "eStatus",
                "source_field" => "usr_status",
                "display_query" => "usr.eStatus",
                "entry_type" => "Table",
                "data_type" => "enum",
                "show_in" => "Both",
                "type" => "dropdown",
                "align" => "center",
                "label" => "Status",
                "lang_code" => "USER_STORE_REVIEW_STATUS",
                "label_lang" => $this->lang->line('USER_STORE_REVIEW_STATUS'),
                "width" => 50,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
                ...
                "editable" => "No",
                "viewedit" => "No",
                "default" => $this->filter->getDefaultValue("usr_status",
                "Text",
                "Pending")
            ),
            "usr_user_id" => array(
                ...
                "align" => "center",
                "label" => "User Id",
                "lang_code" => "USER_STORE_REVIEW_USER_ID",
                "label_lang" => $this->lang->line('USER_STORE_REVIEW_USER_ID'),
                "width" => 50,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
            ...
            "sys_custom_field_1" => array(
                ...
                "align" => "center",
                "label" => "Edit",
                "lang_code" => "USER_STORE_REVIEW_EDIT",
                "label_lang" => $this->lang->line('USER_STORE_REVIEW_EDIT'),
                "width" => 50,
                "search" => "No",
                "export" => "No",
                "sortable" => "Yes",
    ...
    public function getFormConfiguration($name = "")
    {
        $form_config = array(
            ...
            "usr_status" => array(
                ...
                "lang_code" => "USER_STORE_REVIEW_STATUS",
                "label_lang" => $this->lang->line('USER_STORE_REVIEW_STATUS'),
                "default" => $this->filter->getDefaultValue("usr_status","Text","Pending"),
                "dfapply" => "addOnly",
            ),
            "usr_updated_at" => array(
                ...
                "type" => "date",
                "label" => "Updated At",
                "lang_code" => "USER_STORE_REVIEW_UPDATED_AT",
                "label_lang" => $this->lang->line('USER_STORE_REVIEW_UPDATED_AT'),
                "format" => 'Y-m-d',
            )
        );
