 ...
 *
 * @path application\admin\basic_appineers_master\models\USER_REVIEW_IMAGES_model.php
 *
 * @version 4.4
 *
 * @author CIT Dev Team
...
class User_review_images_model extends CI_Model
{
    ...
    public function __construct()
    {
        ...
        $this->table_name = "user_review_images";
        $this->table_alias = "uri";
        $this->primary_key = "iUserReviewImageId";
        $this->primary_alias = "uri_user_review_image_id";
        $this->physical_data_remove = "Yes";
        $this->grid_fields = array(
            "uri_user_review_id",
            "uri_user_review_image",
            "uri_added_at",
            "uri_status",
        );
    ...
    public function getData($extra_cond = "", $fields = "", $order_by = "", $group_by = "", $limit = "", $join = "No", $having_cond = '', $list = FALSE)
    {
        ...
        elseif ($list == TRUE)
        {
            ...
            $this->db->select("uri.iUserReviewId AS uri_user_review_id");
            $this->db->select("uri.vReviewImage AS uri_user_review_image");
            $this->db->select("uri.dtAddedAt AS uri_added_at");
            $this->db->select("uri.eStatus AS uri_status");
        }
        else
        {
            $this->db->select("uri.iUserReviewImageId AS iUserReviewImageId");
            $this->db->select("uri.iUserReviewImageId AS uri_user_review_image_id");
            $this->db->select("uri.iUserReviewId AS uri_user_review_id");
    ...
    public function getListConfiguration($name = "")
    {
        $list_config = array(
            "uri_user_review_id" => array(
                "name" => "uri_user_review_id",
                "table_name" => "user_review_images",
                "table_alias" => "uri",
                "field_name" => "iUserReviewId",
                "source_field" => "uri_user_review_id",
                "display_query" => "uri.iUserReviewId",
                "entry_type" => "Table",
                "data_type" => "int",
                "show_in" => "Both",
                "type" => "dropdown",
                ...
                "lang_code" => "USER_REVIEW_IMAGES_USER_REVIEW_ID",
                "label_lang" => $this->lang->line('USER_REVIEW_IMAGES_USER_REVIEW_ID'),
                "width" => 50,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
            ...
            "uri_review_image" => array(
                "name" => "uri_user_review_images_image",
                "table_name" => "user_review_images",
                "table_alias" => "uri",
                "field_name" => "vReviewImage",
                "source_field" => "uri_user_review_image",
                "display_query" => "uri.vReviewImage",
                "entry_type" => "Table",
                "data_type" => "varchar",
                "show_in" => "Both",
                "type" => "file",
                "align" => "left",
                "label" => "User Review Image",
                "lang_code" => "USER_REVIEW_IMAGES_REVIEW_IMAGE",
                "label_lang" => $this->lang->line('USER_REVIEW_IMAGES_REVIEW_IMAGE'),
                "width" => 50,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
            ...
            "uri_added_at" => array(
                ...
                "source_field" => "uri_added_at",
                "display_query" => "uri.dtAddedAt",
                "entry_type" => "Table",
                "data_type" => "datetime",
                "show_in" => "Both",
                "type" => "date",
                "align" => "left",
                "label" => "Added At",
                "lang_code" => "USER_REVIEW_IMAGES_ADDED_AT",
                "label_lang" => $this->lang->line('USER_REVIEW_IMAGES_ADDED_AT'),
                "width" => 50,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
            ...
            "uri_status" => array(
                ...
                "table_alias" => "uri",
                "field_name" => "eStatus",
                "source_field" => "uri_status",
                "display_query" => "uri.eStatus",
                "entry_type" => "Table",
                "data_type" => "enum",
                "show_in" => "Both",
                "type" => "dropdown",
                "align" => "center",
                "label" => "Status",
                "lang_code" => "USER_REVIEW_IMAGES_STATUS",
                "label_lang" => $this->lang->line('USER_REVIEW_IMAGES_STATUS'),
                "width" => 50,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
    ...
    public function getFormConfiguration($name = "")
    {
        $form_config = array(
            "uri_user_review_id" => array(
                ...
                "show_input" => "Hidden",
                "type" => "dropdown",
                "label" => "User Review Images Id",
                "lang_code" => "USER_REVIEW_IMAGES_USER_REVIEW_ID",
                "label_lang" => $this->lang->line('USER_REVIEW_IMAGES_USER_REVIEW_ID')
            ),
            "uri_review_image" => array(
                "name" => "uri_review_image",
                "table_name" => "user_review_images",
                "table_alias" => "uri",
                "field_name" => "vReviewImage",
                "entry_type" => "Table",
                ...
                "type" => "file",
                "label" => "Image",
                "lang_code" => "USER_REVIEW_IMAGES_IMAGE",
                "label_lang" => $this->lang->line('USER_REVIEW_IMAGES_IMAGE'),
                "file_upload" => "Yes",
                "file_server" => "local",
                "file_folder" => "review_images",
                "file_keep" => "uri_user_review_id",
                "file_width" => "50",
                "file_height" => "50",
