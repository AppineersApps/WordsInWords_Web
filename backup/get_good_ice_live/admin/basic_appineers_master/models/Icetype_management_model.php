...
class Icetype_management_model extends CI_Model
{
    public $table_name;
    public $table_alias;
    public $primary_key;
    ...
    public function __construct()
    {
        ...
        $this->table_name = "icetype";
        $this->table_alias = "i";
        $this->primary_key = "iIcetypeId";
        $this->primary_alias = "i_icetype_id";
    ...
    public function getData($extra_cond = "", $fields = "", $order_by = "", $group_by = "", $limit = "", $join = "No", $having_cond = '', $list = FALSE)
    {
        ...
        elseif ($list == TRUE)
        {
            ...
            $this->db->select("i.vIcetypeName AS i_icetype_name");
            $this->db->select("i.vIcetypeImage AS i_icetype_image");
            $this->db->select("i.eStatus AS i_icetype_status");
            $this->db->select("i.dtAddedAt AS i_added_at");
            $this->db->select("('view') AS sys_custom_field_1", FALSE);
        }
        else
        {
            $this->db->select("i.iIcetypeId AS iIcetypeId");
            $this->db->select("i.iIcetypeId AS i_icetype_id");
    ...
    public function getListConfiguration($name = "")
    {
        $list_config = array(
            ...
            "i_icetype_name" => array(
                "name" => "i_icetype_name",
                "table_name" => "icetype",
                "table_alias" => "i",
                "field_name" => "vIcetypeName",
                "source_field" => "i_icetype_name",
                "entry_type" => "Table",
                "data_type" => "varchar",
                "show_input" => "Both",
                "type" => "textbox",
                "label" => "First Name",
                "lang_code" => "ICETYPE_MANAGEMENT_NAME",
                "label_lang" => $this->lang->line('ICETYPE_MANAGEMENT_NAME'),
                "width" => 50,
            ),
            "i_icetype_image" => array(
                "name" => "i_icetype_image",
                "table_name" => "icetype",
                "table_alias" => "i",
                "field_name" => "vIcetypeImage",
                "source_field" => "i_icetype_image",
                "entry_type" => "Table",
                "data_type" => "varchar",
                "show_input" => "Both",
                "type" => "file",
                "label" => "Icetype Image",
                "lang_code" => "ICETYPE_MANAGEMENT_IMAGE",
                "label_lang" => $this->lang->line('ICETYPE_MANAGEMENT_IMAGE'),
                "file_upload" => "Yes",
                "file_server" => "local",
                "file_folder" => "icetype_image",
                "file_width" => "80",
                "file_height" => "80",
            ...
            "i_icetype_status" => array(
                ...
                "type" => "dropdown",
                "label" => "Status",
                "lang_code" => "ICETYPE_MANAGEMENT_STATUS",
                "label_lang" => $this->lang->line('ICETYPE_MANAGEMENT_STATUS'),
                "width" => 90,
            ),
            "i_added_at" => array(
                "name" => "i_added_at",
                ...
                "align" => "left",
                "label" => "Created On",
                "lang_code" => "ICETYPE_MANAGEMENT_CREATED_ON",
                "label_lang" => $this->lang->line('ICETYPE_MANAGEMENT_CREATED_ON'),
                "width" => 50,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
            ...
            "sys_custom_field_1" => array(
                ...
                "align" => "center",
                "label" => "Edit",
                "lang_code" => "ICETYPE_MANAGEMENT_EDIT",
                "label_lang" => "Edit",
                "width" => 50,
                "search" => "No",
                "export" => "No",
    ...
    public function getFormConfiguration($name = "")
    {
        $form_config = array(
            ...
            "i_added_at" => array(
                ...
                "type" => "date",
                "label" => "Added At",
                "lang_code" => "ICETYPE_MANAGEMENT_ADDED_AT",
                "label_lang" => $this->lang->line('ICETYPE_MANAGEMENT_ADDED_AT'),
