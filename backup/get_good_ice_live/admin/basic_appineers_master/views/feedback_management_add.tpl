            ...
            <div id="scrollable_content" class="scrollable-content popup-content top-block-spacing ">
                <div id="feedback_management" class="frm-module-block frm-elem-block frm-stand-view">
                    ...
                    <form name="frmaddupdate" id="frmaddupdate" action="<%$admin_url%><%$mod_enc_url['add_action']%>?<%$extra_qstr%>" method="post"  enctype="multipart/form-data">
                        ...
                        <input type="hidden" name="uq_updated_at" id="uq_updated_at" value="<%$this->general->dateDefinedFormat('Y-m-d',$data['uq_updated_at'])%>"  class='ignore-valid '  aria-date-format='yy-mm-dd'  aria-format-type='date' />
