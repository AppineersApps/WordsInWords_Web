                ...
                <div id="users_management" class="frm-module-block frm-elem-block frm-stand-view">
                    ...
                    <form name="frmaddupdate" id="frmaddupdate" action="<%$admin_url%><%$mod_enc_url['add_action']%>?<%$extra_qstr%>" method="post"  enctype="multipart/form-data">
                       ...
                       <!--  <input type="hidden" name="u_latitude" id="u_latitude" value="<%$data['u_latitude']|@htmlentities%>"  class='ignore-valid ' />
                        ...
                        <input type="hidden" name="u_added_at" id="u_added_at" value="<%$this->general->dateDefinedFormat('Y-m-d',$data['u_added_at'])%>"  class='ignore-valid '  aria-date-format='yy-mm-dd'  aria-format-type='date' />
                        <input type="hidden" name="u_updated_at" id="u_updated_at" value="<%$this->general->dateDefinedFormat('Y-m-d',$data['u_updated_at'])%>"  class='ignore-valid '  aria-date-format='yy-mm-dd'  aria-format-type='date' />
                                                                    ...
                                                                    <div class="form-right-div  ">
                                                                        <span>
                                                                            ...
                                                                            <div class="frm-gmf-options">
                                                                                ...
                                                                                <label for="u_address-changetype-all">All</label>&nbsp;&nbsp;
                                                                                ...
                                                                                <label for="u_address-changetype-establishment">Establishments</label>&nbsp;&nbsp;
                                                                                ...
                                                                                <label for="u_address-changetype-geocode">Geocodes</label>
                                                                            </div>
