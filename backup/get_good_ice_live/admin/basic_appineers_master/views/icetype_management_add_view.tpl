...
<div class="module-view-container">
    ...
    <div class="<%$module_name%>" data-form-name="<%$module_name%>">
        <div id="ajax_content_div" class="ajax-content-div top-frm-spacing" >
            <input type="hidden" id="projmod" name="projmod" value="icetype_management" />
            <!-- Page Loader -->
            ...
            <div id="scrollable_content" class="scrollable-content popup-content top-block-spacing ">
                <!-- Module View Block -->
                <div id="icetype_management" class="frm-module-block frm-view-block frm-stand-view">
                            ...
                            <div class="box gradient <%$rl_theme_arr['frm_stand_content_row']%> <%$rl_theme_arr['frm_stand_border_view']%>">
                                ...
                                <div class="content <%$rl_theme_arr['frm_stand_label_align']%>">
                                    ...
                                    <div class="form-row row-fluid " id="cc_sh_i_icetype_name">
                                        ...
                                        <div class="form-right-div frm-elements-div  <%if $mode eq 'Update'%>frm-elements-div<%/if%>">
                                            <span class="frm-data-label"><strong><%$data['i_icetype_name']%></strong></span>
                                        </div>
                                    </div>
                                    <div class="form-row row-fluid " id="cc_sh_i_icetype_status">
                                        <label class="form-label span3">
                                            <%$form_config['i_icetype_status']['label_lang']%>
                                        </label> 
                                        <div class="form-right-div frm-elements-div ">
                                            <span class="frm-data-label"><strong><%$this->general->displayKeyValueData($data['i_icetype_status'], $opt_arr['i_icetype_status'])%></strong></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
