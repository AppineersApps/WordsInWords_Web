...
<div class="module-list-container">
    <%include file="user_store_review_index_strip.tpl"%>
...
<%javascript%>
    ...
    el_grid_settings['default_sort'] = 'usr_added_at';
    ...
    {
        "name": "usr_comment",
        "label": "<%$list_config['usr_comment']['label_lang']%>"
    },
    {
        "name": "usr_added_at",
        "label": "<%$list_config['usr_added_at']['label_lang']%>"
    },
    {
        "name": "usr_status",
        "label": "<%$list_config['usr_status']['label_lang']%>"
    },
    {
        "name": "usr_user_id",
        "label": "<%$list_config['usr_user_id']['label_lang']%>"
    },
    {
    ...
    js_col_model_json = [{
        ...
        "editoptions": {
            ...
            "data-placeholder": "<%$this->general->parseLabelMessage('GENERIC_PLEASE_SELECT__C35FIELD_C35' ,'#FIELD#', 'USER_STORE_REVIEW_FULL_NAME')%>",
    ...
    },
    {
        ...
        "labelClass": "header-align-left",
        "resizable": true,
        "width": "<%$list_config['usr_comment']['width']%>",
        "search": <%if $list_config['usr_comment']['search'] eq 'No' %>false<%else%>true<%/if%>,
        "export": <%if $list_config['usr_comment']['export'] eq 'No' %>false<%else%>true<%/if%>,
        "sortable": <%if $list_config['usr_comment']['sortable'] eq 'No' %>false<%else%>true<%/if%>,
        "hidden": <%if $list_config['usr_comment']['hidden'] eq 'Yes' %>true<%else%>false<%/if%>,
        "hideme": <%if $list_config['usr_comment']['hideme'] eq 'Yes' %>true<%else%>false<%/if%>,
        "addable": <%if $list_config['usr_comment']['addable'] eq 'Yes' %>true<%else%>false<%/if%>,
        "editable": <%if $list_config['usr_comment']['editable'] eq 'Yes' %>true<%else%>false<%/if%>,
        "align": "left",
        "edittype": "textarea",
        "editrules": {
            "infoArr": []
        ...
        "searchoptions": {
            "attr": {
                "aria-grid-id": el_tpl_settings.main_grid_id,
                "aria-module-name": "user_store_review",
                "aria-unique-name": "usr_comment",
                "autocomplete": "off"
            },
            "sopt": strSearchOpts,
            "searchhidden": <%if $list_config['usr_comment']['search'] eq 'Yes' %>true<%else%>false<%/if%>
        },
        "editoptions": {
            "aria-grid-id": el_tpl_settings.main_grid_id,
            "aria-module-name": "user_store_review",
        ...
        "ctrl_type": "textarea",
        "default_value": "<%$list_config['usr_comment']['default']%>",
        "filterSopt": "bw"
    },
    {
        "name": "usr_added_at",
        ...
        "labelClass": "header-align-left",
        "resizable": true,
        "width": "<%$list_config['usr_added_at']['width']%>",
        "search": <%if $list_config['usr_added_at']['search'] eq 'No' %>false<%else%>true<%/if%>,
        "export": <%if $list_config['usr_added_at']['export'] eq 'No' %>false<%else%>true<%/if%>,
        "sortable": <%if $list_config['usr_added_at']['sortable'] eq 'No' %>false<%else%>true<%/if%>,
        "hidden": <%if $list_config['usr_added_at']['hidden'] eq 'Yes' %>true<%else%>false<%/if%>,
        "hideme": <%if $list_config['usr_added_at']['hideme'] eq 'Yes' %>true<%else%>false<%/if%>,
        "addable": <%if $list_config['usr_added_at']['addable'] eq 'Yes' %>true<%else%>false<%/if%>,
        "editable": <%if $list_config['usr_added_at']['editable'] eq 'Yes' %>true<%else%>false<%/if%>,
        "align": "left",
        "edittype": "text",
        "editrules": {
            "infoArr": []
        ...
        "searchoptions": {
            "attr": {
                "aria-grid-id": el_tpl_settings.main_grid_id,
                "aria-module-name": "user_store_review",
                "aria-unique-name": "usr_added_at",
                "autocomplete": "off",
                "class": "search-inline-date",
                "aria-date-format": "<%$this->general->getAdminJSMoments('date')%>"
            },
            "sopt": dateSearchOpts,
            "searchhidden": <%if $list_config['usr_added_at']['search'] eq 'Yes' %>true<%else%>false<%/if%>,
        ...
        "ctrl_type": "date",
        "default_value": "<%$list_config['usr_added_at']['default']%>",
        "filterSopt": "bt"
    },
    {
        "name": "usr_status",
        ...
        "resizable": true,
        "width": "<%$list_config['usr_status']['width']%>",
        "search": <%if $list_config['usr_status']['search'] eq 'No' %>false<%else%>true<%/if%>,
        "export": <%if $list_config['usr_status']['export'] eq 'No' %>false<%else%>true<%/if%>,
        "sortable": <%if $list_config['usr_status']['sortable'] eq 'No' %>false<%else%>true<%/if%>,
        "hidden": <%if $list_config['usr_status']['hidden'] eq 'Yes' %>true<%else%>false<%/if%>,
        "hideme": <%if $list_config['usr_status']['hideme'] eq 'Yes' %>true<%else%>false<%/if%>,
        "addable": <%if $list_config['usr_status']['addable'] eq 'Yes' %>true<%else%>false<%/if%>,
        "editable": <%if $list_config['usr_status']['editable'] eq 'Yes' %>true<%else%>false<%/if%>,
        "align": "center",
        "edittype": "select",
        "editrules": {
            "infoArr": []
        ...
        "searchoptions": {
            ...
            "sopt": intSearchOpts,
            "searchhidden": <%if $list_config['usr_status']['search'] eq 'Yes' %>true<%else%>false<%/if%>,
            "dataUrl": <%if $count_arr["usr_status"]["json"] eq "Yes" %>false<%else%>'<%$admin_url%><%$mod_enc_url["get_list_options"]%>?alias_name=usr_status&mode=<%$mod_enc_mode["Search"]%>&rformat=html<%$extra_qstr%>'<%/if%>,
            "value": <%if $count_arr["usr_status"]["json"] eq "Yes" %>$.parseJSON('<%$count_arr["usr_status"]["data"]|@addslashes%>')<%else%>null<%/if%>,
            "dataInit": <%if $count_arr['usr_status']['ajax'] eq 'Yes' %>initSearchGridAjaxChosenEvent<%else%>initGridChosenEvent<%/if%>,
            "ajaxCall": '<%if $count_arr["usr_status"]["ajax"] eq "Yes" %>ajax-call<%/if%>',
            "multiple": true
        },
        "editoptions": {
            "aria-grid-id": el_tpl_settings.main_grid_id,
            "aria-module-name": "user_store_review",
            "aria-unique-name": "usr_status",
            "dataUrl": '<%$admin_url%><%$mod_enc_url["get_list_options"]%>?alias_name=usr_status&mode=<%$mod_enc_mode["Update"]%>&rformat=html<%$extra_qstr%>',
            "dataInit": <%if $count_arr['usr_status']['ajax'] eq 'Yes' %>initEditGridAjaxChosenEvent<%else%>initGridChosenEvent<%/if%>,
            "ajaxCall": '<%if $count_arr["usr_status"] eq "Yes" %>ajax-call<%/if%>',
            "data-placeholder": "<%$this->general->parseLabelMessage('GENERIC_PLEASE_SELECT__C35FIELD_C35' ,'#FIELD#', 'USER_STORE_REVIEW_STATUS')%>",
            "class": "inline-edit-row chosen-select"
        },
        "ctrl_type": "dropdown",
        "default_value": "<%$list_config['usr_status']['default']%>",
        "filterSopt": "in",
        "stype": "select"
    },
    {
        ...
        "labelClass": "header-align-center",
        "resizable": true,
        "width": "<%$list_config['usr_user_id']['width']%>",
        "search": <%if $list_config['usr_user_id']['search'] eq 'No' %>false<%else%>true<%/if%>,
        "export": <%if $list_config['usr_user_id']['export'] eq 'No' %>false<%else%>true<%/if%>,
        "sortable": <%if $list_config['usr_user_id']['sortable'] eq 'No' %>false<%else%>true<%/if%>,
        "hidden": <%if $list_config['usr_user_id']['hidden'] eq 'Yes' %>true<%else%>false<%/if%>,
        "hideme": <%if $list_config['usr_user_id']['hideme'] eq 'Yes' %>true<%else%>false<%/if%>,
        "addable": <%if $list_config['usr_user_id']['addable'] eq 'Yes' %>true<%else%>false<%/if%>,
        "editable": <%if $list_config['usr_user_id']['editable'] eq 'Yes' %>true<%else%>false<%/if%>,
        "align": "center",
        "edittype": "select",
        "editrules": {
            "infoArr": []
        ...
        "searchoptions": {
            ...
            "sopt": intSearchOpts,
            "searchhidden": <%if $list_config['usr_user_id']['search'] eq 'Yes' %>true<%else%>false<%/if%>,
            "dataUrl": <%if $count_arr["usr_user_id"]["json"] eq "Yes" %>false<%else%>'<%$admin_url%><%$mod_enc_url["get_list_options"]%>?alias_name=usr_user_id&mode=<%$mod_enc_mode["Search"]%>&rformat=html<%$extra_qstr%>'<%/if%>,
            "value": <%if $count_arr["usr_user_id"]["json"] eq "Yes" %>$.parseJSON('<%$count_arr["usr_user_id"]["data"]|@addslashes%>')<%else%>null<%/if%>,
            "dataInit": <%if $count_arr['usr_user_id']['ajax'] eq 'Yes' %>initSearchGridAjaxChosenEvent<%else%>initGridChosenEvent<%/if%>,
            "ajaxCall": '<%if $count_arr["usr_user_id"]["ajax"] eq "Yes" %>ajax-call<%/if%>',
            "multiple": true
        },
        "editoptions": {
            "aria-grid-id": el_tpl_settings.main_grid_id,
            "aria-module-name": "user_store_review",
            "aria-unique-name": "usr_user_id",
            "dataUrl": '<%$admin_url%><%$mod_enc_url["get_list_options"]%>?alias_name=usr_user_id&mode=<%$mod_enc_mode["Update"]%>&rformat=html<%$extra_qstr%>',
            "dataInit": <%if $count_arr['usr_user_id']['ajax'] eq 'Yes' %>initEditGridAjaxChosenEvent<%else%>initGridChosenEvent<%/if%>,
            "ajaxCall": '<%if $count_arr["usr_user_id"] eq "Yes" %>ajax-call<%/if%>',
            "data-placeholder": "<%$this->general->parseLabelMessage('GENERIC_PLEASE_SELECT__C35FIELD_C35' ,'#FIELD#', 'USER_STORE_REVIEW_USER_ID')%>",
            "class": "inline-edit-row chosen-select"
        },
        "ctrl_type": "dropdown",
        "default_value": "<%$list_config['usr_user_id']['default']%>",
        "filterSopt": "in",
        "stype": "select"
    },
    {
