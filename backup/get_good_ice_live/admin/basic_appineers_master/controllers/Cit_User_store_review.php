...
Class Cit_User_store_review extends User_store_review {
...
{	    
        $url = $this->general->getAdminEncodeURL('basic_appineers_master/user_store_review/add').'|mode|'.$this->general->getAdminEncodeURL('Update').'|id|'.$this->general->getAdminEncodeURL($arr);
