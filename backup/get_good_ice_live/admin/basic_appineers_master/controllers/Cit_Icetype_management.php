...
Class Cit_Icetype_management extends Icetype_management {
...
{     
        $url = $this->general->getAdminEncodeURL('basic_appineers_master/icetype_management/add').'|mode|'.$this->general->getAdminEncodeURL('Update').'|id|'.$this->general->getAdminEncodeURL($arr);
